...
export default function Category() {
  return (
    <div className='relative flex flex-col items-center justify-center h-30 w-70 bg-red-500 rounded-xl shadow-lg mt-5 p-10 bg-center bg-cover bg-no-repeat'
        style={{ backgroundImage: "url('https://img.freepik.com/premium-photo/birthdays-celebrated-pink-cake_961875-119143.jpg')" }}
    >
      ...
      <div className="relative z-10 flex items-center justify-center h-full text-white text-2xl font-semibold cursor-pointer">
    Birthday Cakes
     </div>
    </div>
  )
